...
?>
		...
		-->
	    	...
	    	<div class="sidebar-wrapper">
				...
				<?php } ?>
				<?php if($role==1 or $role==2 or $role==3){ ?>
					<li <?php if($activepage=="advance-history.php"){?> class="active" <?php }else {}  ?> >
	                    <a href="advance-history.php" >
	                        <i class="ti-money"></i>
	                        <p>Advance History</p>
	                    </a>
	                </li>
				<?php } ?>
				<?php if($role==1 or $role==2 or $role==3){ ?>
					<li <?php if($activepage=="khada-list.php"){?> class="active" <?php }else {}  ?> >
	                    <a href="khada-list.php" >
	                        <i class="ti-na"></i>
	                        <p>Khada List</p>
	                    </a>
	                </li>
