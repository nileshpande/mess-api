...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2017 at 07:44 AM
...
INSERT INTO `student` (`reg_id`, `fname`, `mname`, `lname`, `addres_permanant`, `address_corespondance`, `phone_number`, `mobile`, `department`, `branch`, `hostel_no`, `room_no`, `blood_grp`, `start_date_mess`, `photo`, `year`, `deactivated`, `update_date`, `deactivated_date`, `deactivate_type`) VALUES
